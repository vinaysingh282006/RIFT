...
interface RiskAssessmentPanelProps {
  drugRisk?: DrugRisk; // Optional for now, falls back to mock
}

export function RiskAssessmentPanel({ drugRisk }: RiskAssessmentPanelProps) {
  const primaryDrug = drugRisk || mockResult.primaryDrug;
